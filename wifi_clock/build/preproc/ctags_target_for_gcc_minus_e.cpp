# 1 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino"
# 2 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 3 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 4 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 5 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2





# 11 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 12 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 13 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 14 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2

# 16 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 17 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 18 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2


# 21 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2


# 24 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 25 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 26 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2

# 28 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 29 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 30 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2

# 32 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 33 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 34 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2

# 36 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 37 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
# 38 "d:\\项目\\开源项目\\wifi_clock\\wifi_clock\\wifi_clock.ino" 2
...
U8G2_SSD1306_128X64_NONAME_F_HW_I2C u8g2((&u8g2_cb_r0), /* reset=*/ 255, /* clock=*/ 2, /* data=*/ 0); //配置构造函数，使用硬件IIC
...
void setup(void)
{
  ...
  //时间服务器的请求
  configTime(((8 /* 中国时区为8*/)*3600), ((0 /* 默认为0*/)*60), "ntp.ntsc.ac.cn", "ntp1.aliyun.com");//获取当前时间
...
void drawDateTime() //显示时间
{
  ...
  sprintf_P(buff, (__extension__({static const char __c[] __attribute__((__aligned__(4))) __attribute__((section( "\".irom0.pstr." "wifi_clock.ino" "." "315" "." "250" "\", \"aSM\", @progbits, 1 #"))) = ("%04d-%02d-%02d %s"); &__c[0];})), timeInfo->tm_year + 1900, timeInfo->tm_mon + 1, timeInfo->tm_mday, WDAY_NAMES[timeInfo->tm_wday].c_str());
  u8g2.setFont(u8g2_font_wqy14_t_gb2312a);
  u8g2.setCursor(9 , 20 ); //年份居中显示
  u8g2.println(buff);//显示出年份
  sprintf_P(buff, (__extension__({static const char __c[] __attribute__((__aligned__(4))) __attribute__((section( "\".irom0.pstr." "wifi_clock.ino" "." "319" "." "251" "\", \"aSM\", @progbits, 1 #"))) = ("%02d:%02d:%02d"); &__c[0];})), timeInfo->tm_hour, timeInfo->tm_min, timeInfo->tm_sec);//中间大时间
...
void drawEyebow(int16_t x, int16_t y, int page, const char*someData) //绘制底栏
{
  ...
  timeInfo = localtime(&now);
  char buff[16];
  sprintf_P(buff, (__extension__({static const char __c[] __attribute__((__aligned__(4))) __attribute__((section( "\".irom0.pstr." "wifi_clock.ino" "." "500" "." "252" "\", \"aSM\", @progbits, 1 #"))) = ("%02d:%02d"); &__c[0];})), timeInfo->tm_hour, timeInfo->tm_min);//底栏小时间
  u8g2.setFont(u8g2_font_6x12_tf);
